...
namespace Microsoft.AspNetCore.Mvc.Filters
{
    public static class FilterCollectionExtensions
    {
        ...
        public static FilterCollection AddAzureManagedIdentityAuthorization(this FilterCollection filters, IServiceCollection serviceDependencies)
        {
            ...
            return filters.AddAzureManagedIdentityAuthorization(serviceDependencies, (options) => options);
        }
        ...
        public static FilterCollection AddAzureManagedIdentityAuthorization(this FilterCollection filters, IServiceCollection serviceDependencies, Func<AzureManagedIdentityAuthorizationOptions, AzureManagedIdentityAuthorizationOptions> options)
        {
            Guard.NotNull(filters, nameof(filters));

            var azureManagedIdentityAuthorizationOptions = options(AzureManagedIdentityAuthorizationOptions.Default);
